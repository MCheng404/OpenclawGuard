...
Item {
    ...
    ColumnLayout { anchors.fill: parent; spacing: 16
        Label { text: "环境检测"; font.pixelSize: 22; font.bold: true; color: isDark ? "#e2e4f0" : "#1e293b" }
        Rectangle { Layout.fillWidth: true; Layout.fillHeight: true; radius: 16; color: isDark ? "#222540" : "#ffffff"
            Label { anchors.centerIn: parent; text: "Node.js / Python / Git / npm"; color: isDark ? "#8b8fa3" : "#64748b" }
        }
    }}
}
