...
QString Theme::darkStyleSheet()
{
    return QStringLiteral(
        ...
        "QWidget#sidebar { background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 rgba(23,25,43,0.70), stop:1 rgba(23,25,43,0.95)); border: 1px solid rgba(255,255,255,0.06); border-radius: 16px; }\n"
        ...
        "QPushButton#navBtn:hover { background: rgba(255,255,255,0.07); border: 1px solid rgba(255,255,255,0.06); color: #eef2ff; padding-left: 16px; }\n"
        "QPushButton#navBtn:checked { background: rgba(79,140,255,0.12); border: none; border-left: 3px solid #4f8cff; color: #8fb4ff; font-weight: 700; padding-left: 11px; }\n"
        "QPushButton#navBtn:focus { border: none; border-left: 3px solid transparent; }\n"
        ...
        "QFrame#card { background: palette(base); border: none; border-radius: 16px; }\n"
        "QFrame#statCard { background: palette(base); border: none; border-radius: 16px; }\n"
        "QFrame#statCard:hover { border: none; }\n"
        "QFrame[dashboardCard=\"true\"] { background: palette(base); border: 1px solid rgba(79,140,255,0.10); border-radius: 16px; }\n"
        "QFrame[dashboardCard=\"true\"]:hover { border: 1px solid rgba(79,140,255,0.22); background: palette(base); }\n"
        ...
        "QPushButton#primaryBtn:hover { background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #6ea8ff, stop:1 #5090ff); border: 1px solid rgba(140,183,255,0.30); padding-top: 8px; padding-bottom: 10px; }\n"
        ...
        "QPushButton#secondaryBtn:disabled { background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.04); color: #6b6b8a; }\n"        "QPushButton#tokenToggleBtn { background: transparent; border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 0; icon-size: 18px; }\n"        "QPushButton#tokenToggleBtn:hover { background: rgba(79,140,255,0.12); border: 1px solid rgba(79,140,255,0.20); }\n"        "QPushButton#tokenToggleBtn:pressed { background: rgba(79,140,255,0.18); }\n"        "QPushButton#githubLinkBtn { background: transparent; color: #8fb4ff; border: 1px solid rgba(79,140,255,0.15); border-radius: 10px; padding: 8px 16px; font-size: 12px; font-weight: 600; font-family: \"Consolas\", \"JetBrains Mono\", monospace; text-align: left; }\n"        "QPushButton#githubLinkBtn:hover { background: rgba(79,140,255,0.08); border: 1px solid rgba(79,140,255,0.30); color: #b0ccff; }\n"        "QPushButton#githubLinkBtn:pressed { background: rgba(79,140,255,0.14); }\n"
        ...
        "QLineEdit, QSpinBox { background: #15162a; color: #e2e4f0; border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; padding: 9px 14px; font-size: 13px; }\n"
        ...
        "QLabel#sliderValueLabel { color: #4f8cff; font-size: 13px; font-weight: 700; font-family: 'JetBrains Mono', 'Consolas', monospace; }\n"
        ...
        "QHeaderView::section { background: rgba(255,255,255,0.04); color: #9ca3bd; border: none; border-bottom: 2px solid rgba(79,140,255,0.12); padding: 10px 12px; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; }\n"
        ...
        "QListWidget#activityList::item { color: #cfd3e8; padding: 10px 14px; border-radius: 10px; background: rgba(255,255,255,0.03); margin: 2px 0; }\n"
        "QListWidget#activityList::item:hover { background: rgba(79,140,255,0.10); color: #eef2ff; }\n"
        "QListWidget#activityList::item:selected { background: rgba(79,140,255,0.14); color: #eef2ff; }\n"
        ...
        "QProgressBar#resourceBar { background: rgba(255,255,255,0.06); border: none; border-radius: 4px; height: 8px; }\n"
        "QProgressBar#resourceBar::chunk { background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #4f8cff, stop:1 #34d399); border-radius: 4px; }\n"
        ...
        "QScrollBar:horizontal { background: rgba(255,255,255,0.02); height: 8px; margin: 2px; border-radius: 4px; }\n"
        ...
        "QLabel#emptyState { color: #6b7194; font-size: 13px; padding: 48px 24px; border: 1px dashed rgba(79,140,255,0.15); border-radius: 14px; background: rgba(79,140,255,0.02); }\n"
...
QString Theme::lightStyleSheet()
{
    return QStringLiteral(
        ...
        "QWidget#sidebar { background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 rgba(240,241,245,0.70), stop:1 rgba(240,241,245,0.97)); border: 1px solid rgba(0,0,0,0.06); border-radius: 16px; }\n"
        ...
        "QPushButton#navBtn:hover { background: rgba(59,130,246,0.05); border: 1px solid rgba(59,130,246,0.08); color: #0f172a; padding-left: 16px; }\n"
        "QPushButton#navBtn:checked { background: rgba(59,130,246,0.10); border: none; border-left: 3px solid #3b82f6; color: #2563eb; font-weight: 700; padding-left: 11px; }\n"
        "QPushButton#navBtn:focus { border: none; border-left: 3px solid transparent; }\n"
        ...
        "QFrame#statCard { background: palette(base); border: none; border-radius: 16px; }\n"
        "QFrame#statCard:hover { border: none; }\n"
        "QFrame[dashboardCard=\"true\"] { background: palette(base); border: 1px solid rgba(59,130,246,0.10); border-radius: 16px; }\n"
        "QFrame[dashboardCard=\"true\"]:hover { border: 1px solid rgba(59,130,246,0.22); background: palette(base); }\n"
        ...
        "QPushButton#primaryBtn:hover { background: #60a5fa; border: 1px solid rgba(59,130,246,0.20); padding-top: 8px; padding-bottom: 10px; }\n"
        ...
        "QLabel#sliderValueLabel { color: #3b82f6; font-size: 13px; font-weight: 700; font-family: 'JetBrains Mono', 'Consolas', monospace; }\n"
        ...
        "QListWidget#activityList::item { color: #334155; padding: 10px 14px; border-radius: 10px; background: rgba(59,130,246,0.04); margin: 2px 0; }\n"
        "QListWidget#activityList::item:hover { background: rgba(59,130,246,0.10); color: #0f172a; }\n"
        "QListWidget#activityList::item:selected { background: rgba(59,130,246,0.14); color: #0f172a; }\n"
        ...
        "QProgressBar#resourceBar { background: rgba(0,0,0,0.06); border: none; border-radius: 4px; height: 8px; }\n"
        "QProgressBar#resourceBar::chunk { background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #3b82f6, stop:1 #10b981); border-radius: 4px; }\n"
        "QScrollBar:vertical { background: rgba(0,0,0,0.02); width: 8px; margin: 2px; border-radius: 4px; }\n"
        "QScrollBar::handle:vertical { background: rgba(0,0,0,0.14); border-radius: 4px; min-height: 30px; }\n"
        "QScrollBar::handle:vertical:hover { background: rgba(0,0,0,0.28); }\n"
        "QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical { height: 0; }\n"
        "QScrollBar:horizontal { background: rgba(0,0,0,0.02); height: 8px; margin: 2px; border-radius: 4px; }\n"
        "QScrollBar::handle:horizontal { background: rgba(0,0,0,0.14); border-radius: 4px; min-width: 30px; }\n"
