...
QString Theme::darkStyleSheet()
{
    return QStringLiteral(
        ...
        "QListWidget#activityList::item:hover { background: rgba(79,140,255,0.08); }\n"
        "QListWidget#activityList::item:selected { background: rgba(79,140,255,0.12); color: #eef2ff; }\n"
...
QString Theme::lightStyleSheet()
{
    return QStringLiteral(
        ...
        "QListWidget#activityList::item:hover { background: rgba(59,130,246,0.08); }\n"
        "QListWidget#activityList::item:selected { background: rgba(59,130,246,0.12); color: #0f172a; }\n"
