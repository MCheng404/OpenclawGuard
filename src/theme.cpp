...
QString Theme::darkStyleSheet()
{
    return QStringLiteral(
        ...
        "QFrame[dashboardCard=\"true\"]:hover { border: 1px solid rgba(79,140,255,0.22); background: rgba(79,140,255,0.03); }\n"
        "QFrame[pageTopCard=\"true\"] { border: 1px solid rgba(79,140,255,0.14); background: rgba(79,140,255,0.03); }\n"
        "QFrame[pageTopCard=\"true\"]:hover { border: 1px solid rgba(79,140,255,0.26); background: rgba(79,140,255,0.06); }\n"
...
QString Theme::lightStyleSheet()
{
    return QStringLiteral(
        ...
        "QFrame[dashboardCard=\"true\"]:hover { border: 1px solid rgba(59,130,246,0.22); background: rgba(59,130,246,0.03); }\n"
